...
-- 2024-08-11,JJavier,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JJavier')
	 Begin 
	  Alter Database [Assignment07DB_JJavier] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JJavier;
	 End
	Create Database Assignment07DB_JJavier;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JJavier;
